...
def scrape_internshala():
    URL = ["https://internshala.com/internships/computer-science-internship/","https://internshala.com/internships/computer-science-internship/page-2/","https://internshala.com/internships/computer-science-internship/page-3/","https://internshala.com/internships/computer-science-internship/page-4/","https://internshala.com/internships/computer-science-internship/page-5/"]
...
def recommend_internships(query, df, num_recommendations=10):
    ...
    similarities = [util.pytorch_cos_sim(query_embedding, emb)[0].item() for emb in df["Embedding"]]
    ...
    return recommendations[["Title", "Company", "Stipend", "Link"]].reset_index(drop=True)
